...
const SearchForm = ()=>{
    ...
    return(
        <div className="flex flex-col gap-[50px]">
            ...
            <div className="flex flex-col bg-white h-[180px]  border  border-gray-300 rounded-[11px] justify-between pt-[50px] pb-[10px]">
           <form id="filter" action={onSubmit} className="flex itens-center justify-around ">
            <label  className="flex flex-col  text-gray-600 font-semibold ">{titel('recherche')}
                <div className="border border-gray-300 rounded-[5px] flex justify-around h-[28px] font-light">
                    <Search className="w-[20px] mx-[5px] text-gray-300"/>
                     <input
            name="q"
...
<label  className="flex flex-col font-semibold text-gray-600 ">
    {titel('lieu')}
     <div className="border border-gray-300 rounded-[5px] flex justify-around h-[28px] font-light">
        <MapPin className="w-[20px] mx-[5px] text-gray-300"/>
    <input
            name="q"
...
<label  className="flex flex-col font-semibold text-gray-600">
    {titel('secteur')}
      <div className="border border-gray-300 rounded-[5px] flex justify-around font-light">
        <Building className="w-[20px] mx-[5px] text-gray-300"/>
            <select name="sector" defaultValue={sp.get('sector') ??''}  className="h-[28px] w-[200px]">
...
<label  className="flex flex-col font-semibold text-gray-600   ">
    {titel('salaire')}
     <div className="border border-gray-300 rounded-[5px] flex justify-around font-light">
        <Euro className="w-[20px] mx-[5px] text-gray-300"/>
            <input
        name="minSalary"
        type="number"
        step="50"
